...
const RegistrationForm = () => {
  return (
    <main className="flex-grow flex items-center justify-center  py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-2xl space-y-8 shadow-2xl p-10 rounded-lg">
        <div className="text-center">
          <h1 className="text-3xl font-bold tracking-tight text-green-950 dark:text-text-dark sm:text-4xl">
            Basic Information
          </h1>
