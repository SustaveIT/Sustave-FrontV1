...
export default function AboutSection() {
  return (
    <section
      className="py-16 md:py-24 bg-gray-50 bg-green-200 rounded rounded-b-3xl z-20"
      id="about"
    >
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1">
            ...
            <p className="text-base md:text-lg text-gray-700 leading-relaxed">
              ...
              platform, users globally can pre-sponsor real moringa farms, track
              impact and earn from sustainable agriculture or climate action.
            </p>
          </div>
