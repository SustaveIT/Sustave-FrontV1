...
export default function Footer() {
  ...
  return (
    <footer className="bg-green-900 text-white pt-16 pb-8" id="footer">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-12">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-green-200 mb-4">
                Building Africa's largest network of moringa planters through
                blockchain, AI and a women - centered model.
              </p>

              <p className="text-green-200 mb-6">
                Join us in creating sustainable wealth while transforming
                communities and our planet at large.
              </p>
